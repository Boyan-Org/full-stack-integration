# Generated by Django 3.1.2 on 2020-11-28 20:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctorID', models.ForeignKey(db_column='doctorID', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='api.account')),
                ('patientID', models.ForeignKey(db_column='patientID', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='api.account')),
            ],
            options={
